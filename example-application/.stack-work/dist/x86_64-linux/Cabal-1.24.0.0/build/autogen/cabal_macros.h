...
/* package example-application-0.1.0.0 */
#define VERSION_example_application "0.1.0.0"
#define MIN_VERSION_example_application(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "example-application-0.1.0.0-6ZkdYfBLqGpCqzZHgxtcqX"

#define CURRENT_PACKAGE_KEY "example-application-0.1.0.0-6ZkdYfBLqGpCqzZHgxtcqX"
