...
/* package client-proxy-0.1.0.0 */
#define VERSION_client_proxy "0.1.0.0"
#define MIN_VERSION_client_proxy(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "client-proxy-0.1.0.0-5MbByLF2LGy9XhzIXD22AJ"

#define CURRENT_PACKAGE_KEY "client-proxy-0.1.0.0-5MbByLF2LGy9XhzIXD22AJ"
