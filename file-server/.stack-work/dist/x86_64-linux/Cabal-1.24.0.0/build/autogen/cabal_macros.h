...
/* package directory-server-0.1.0.0 */
#define VERSION_directory_server "0.1.0.0"
#define MIN_VERSION_directory_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "directory-server-0.1.0.0-1QKvqFDw4is6KimF8oymfh"

#define CURRENT_PACKAGE_KEY "directory-server-0.1.0.0-1QKvqFDw4is6KimF8oymfh"
